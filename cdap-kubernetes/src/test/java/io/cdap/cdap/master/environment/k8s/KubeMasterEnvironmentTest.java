...
public class KubeMasterEnvironmentTest {
  ...
  public void testOnNamespaceCreationWithWorkloadIdentityEnabled() throws Exception {
    ...
    String workloadIdentityGCPServiceAccount = "test-service-account@iam.gserviceaccount.com";
    String workloadIdentityGCPProjectID = "test-project-id";
    ...
    kubeMasterEnvironment.setWorkloadIdentityGcpProjectId(workloadIdentityGCPProjectID);
  ...
  private void assertContainsVolume(V1Pod pod, V1Volume expectedVolume) {
    ...
    Assert.fail(String.format("Expected volume '%s' not found in pod spce '%s'", expectedVolume.getName(),
