...
public class RunRecord {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pid, startTs, runTs, stopTs, suspendTs, resumeTs, stoppingTs, status, properties, cluster,
                        profileId);
  }
  ...
  public static class Builder<T extends Builder> {
    ...
    public RunRecord build() {
      ...
      return new RunRecord(pid, startTs, runTs, stopTs, suspendTs, resumeTs, stoppingTs, status, properties, cluster,
                           profileId);
    }
  }
}
