...
import io.cdap.cdap.metrics.publisher.BufferedMetricsPublisher;
import io.cdap.cdap.metrics.publisher.MetricsWritersMetricsPublisher;

/**
 * Guice module that provided mappings for SystemMetricsExporterServiceMain
 */
public class SystemMetricsExporterModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(MetricsPublisher.class)
      .annotatedWith(BufferedMetricsPublisher.Base.class)
      .to(MetricsWritersMetricsPublisher.class);
    bind(MetricsPublisher.class).to(BufferedMetricsPublisher.class);
